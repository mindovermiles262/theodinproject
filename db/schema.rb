...
ActiveRecord::Schema.define(version: 20_190_623_211_940) do
  ...
  create_table 'lesson_completions', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[lesson_id student_id], name: 'index_lesson_completions_on_lesson_id_and_student_id', unique: true
  ...
  create_table 'lessons', id: :serial, force: :cascade do |t|
    ...
    t.index %w[slug section_id], name: 'index_lessons_on_slug_and_section_id', unique: true
  end
  ...
  create_table 'projects', id: :serial, force: :cascade do |t|
    ...
    t.index %w[user_id lesson_id], name: 'index_projects_on_user_id_and_lesson_id', unique: true
